 ...
 * @brief 亮色主题类
 * 
 * LightTheme提供应用程序的亮色主题样式，适合在明亮环境下使用，
 * 包括浅色背景、深色文字和清晰的UI元素样式。
 */
...
private:
    ...
    void setupLightFonts();
    void setupLightSizes();
    QString generateLightButtonStyleSheet() const;
    QString generateLightMenuStyleSheet() const;
